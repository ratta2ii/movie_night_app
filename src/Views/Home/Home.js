...
//             <Grid container>
//                 {/* Margin left main container */}
//                 <Grid item xs={1} lg={2} xl={1}></Grid>
//                 <Grid item xs={10} lg={8} xl={10} style={{backgroundColor: 'red',}} >
//                     {/* //? Main container (All content here) */}
//                     <Box className={classes.headerContainer} >
//                         <Button
//                             component={Link}
...
//             </Grid>
//             <Grid container>
//                 <Grid item xs={1} sm={0} lg={2} xl={1}></Grid>
//                 <Grid item xs={10} sm={10} lg={8} xl={10} className={classes.productListContainer}>
